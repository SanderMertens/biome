...
bake_test_case Logistics_testcases[] = {
    ...
    {
        "catch_move_to_deleted_destination",
        Logistics_catch_move_to_deleted_destination
    },
    {
        "catch_dropoff_at_deleted_destination",
        Logistics_catch_dropoff_at_deleted_destination
    },
    {
