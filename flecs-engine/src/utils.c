...
ecs_entity_t flecsEngine_vecI8(
    ecs_world_t *world)
{
    return ecs_vector(world, {
        .entity = ecs_entity(world, {
            .name = "::flecs.engine.types.vecI8",
            .root_sep = "::"
        }),
...
ecs_entity_t flecsEngine_vecF32(
    ecs_world_t *world)
{
    return ecs_vector(world, {
        .entity = ecs_entity(world, {
            .name = "::flecs.engine.types.vecF32",
            .root_sep = "::"
        }),
...
ecs_entity_t flecsEngine_vecRgba(
    ecs_world_t *world)
{
    return ecs_vector(world, {
        .entity = ecs_entity(world, {
            .name = "::flecs.engine.types.vecRgba",
            .root_sep = "::"
        }),
        .type = ecs_id(flecs_rgba_t)
    });
}
